...
export default function Footer({ textColor = 'white' }: FooterProps) {
    ...
    const placeholderColorClass = `placeholder-${textColor}`;
          ...
          <div className="max-w-7xl mx-auto flex flex-col-reverse sm:flex-row justify-between items-center gap-4">
            ...
            <div className="w-full sm:w-auto">
              <div className="flex gap-2 w-full sm:w-auto">
                <input
                  ...
                  className={`bg-transparent border ${borderColorClass}/20 rounded-full px-4 py-2 text-sm ${textColorClass} ${placeholderColorClass}/50 focus:outline-none focus:border-${textColor}/40 w-full sm:w-[245px]`}
                />
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 w-full sm:w-auto mb-4 sm:mb-0">
              ...
              <div className="text-center sm:text-left">
                <span className={`${textColorClass} opacity-20 hover:opacity-40 transition-opacity text-sm`}>
